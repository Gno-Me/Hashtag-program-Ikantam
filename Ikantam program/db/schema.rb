...
ActiveRecord::Schema.define(version: 20141006091047) do
  ...
  create_table "hashtags", force: true do |t|
    ...
    t.string   "grabbed_socials"
  end

  create_table "hashtags_users", id: false, force: true do |t|
  ...
  add_index "posts", ["hashtag_id"], name: "index_posts_on_hashtag_id", using: :btree
